...
public class SimpaticoResourceCTZP {
    ...
    public Response insert_content_request(@Context HttpServletRequest request, String postData) {
    	/* JSON: {userID: <string>, e-serviceID: <string>, annotableElementID: <string>}   							event: citizenpedia_content_request
    	 		 {userID: <string>, e-serviceID: <string>, annotableElementID: <string>, questionID: <string>}   	event: citizenpedia_question_request
    	 		 {userID: <string>, e-serviceID: <string>, annotableElementID: <string>}   							event: citizenpedia_new_question
    	 		 {userID: <string>, e-serviceID: <string>, annotableElementID: <string>, questionID: <string>}   	event: citizenpedia_new_answer
    	 		 {userID: <string>, e-serviceID: <string>, annotableElementID: <string>, selected_term: <string>}   event: citizenpedia_term_request
    	*/
    	...
    	try {
	    	...
	    	if (jsonObject != null) {
	    		if (jsonObject.length() == 3 && jsonObject.has(USER_ID) && jsonObject.has(E_SERVICE_ID) && jsonObject.has(ANNOTABLE_ELEMENT_ID)) {
	    			badRequest = false;
    ...
    public Response update_term_request(@Context HttpServletRequest request, String postData) {
    	...
    	*/
    	...
    	try {
	    	...
	    	JSONObject jsonObject = Utils.createJSONObjectIfValid(postData);
	    	if (jsonObject != null) {
	    		if (jsonObject.length() == 5 && jsonObject.has(USER_ID) && jsonObject.has(E_SERVICE_ID) && jsonObject.has(ANNOTABLE_ELEMENT_ID) // 5: id attr
	    				&& jsonObject.has(SELECTED_TERM)) {
	    			badRequest = false;
	    			jsonObject.put(EVENT, EVENT_TERM_REQUEST);
	    		}
