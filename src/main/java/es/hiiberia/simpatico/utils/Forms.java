...
public class Forms {
	...
	public static String DIALOG_SIMPLIFICATION = 
			"<!-- Slider -->"+
			  "<div id=\"slider-session-feedback-content\">"+
			    ...
			    "</div>"+
			    "<form>"+
			      "<input id=\"slider_session_feedback_paragraph\" class=\"slider\" type=\"range\" min=\"-5\" max=\"5\" step=\"1\" value=\"0\" oninput=\"sliderOutputSessionFeedback.value = slider_session_feedback.value\"/>"+
			  ...
			  "<div id=\"slider-session-feedback-content\">"+
			    ...
			    "</div>"+
			    "<form>"+
			      "<input id=\"slider_session_feedback_phrase\" class=\"slider\" type=\"range\" min=\"-5\" max=\"5\" step=\"1\" value=\"0\" oninput=\"sliderOutputSessionFeedback.value = slider_session_feedback.value\"/>"+
			      "<div class=\"slider-horizontal-text-below-left\">Nada útil</div>"+
			      "<div class=\"slider-horizontal-text-below-right\">Muy útil</div>"+
			      "<div id=\"slider-output-session-feedback\" style=\"text-align: center;\"><output id=\"sliderOutputSessionFeedback\">0</output></div>"+
			    "</form>"+
			  ...
			  "<div id=\"slider-session-feedback-content\">"+
			    ...
			    "</div>"+
			    "<form>"+
			      "<input id=\"slider_session_feedback_word\" class=\"slider\" type=\"range\" min=\"-5\" max=\"5\" step=\"1\" value=\"0\" oninput=\"sliderOutputSessionFeedback.value = slider_session_feedback.value\"/>"+
			      "<div class=\"slider-horizontal-text-below-left\">Nada útil</div>"+
			      "<div class=\"slider-horizontal-text-below-right\">Muy útil</div>"+
			      "<div id=\"slider-output-session-feedback\" style=\"text-align: center;\"><output id=\"sliderOutputSessionFeedback\">0</output></div>"+
			    "</form>"+
	...
	public static String DIALOG_CTZPEDIA = 
			...
			"<div id=\"slider-session-feedback-content\">"+
			  ...
			  "</div>"+
			  "<form>"+
			    "<input id=\"slider_session_feedback_ctz\" class=\"slider\" type=\"range\" min=\"-5\" max=\"5\" step=\"1\" value=\"0\" oninput=\"sliderOutputSessionFeedback.value = slider_session_feedback.value\"/>"+
			    "<div class=\"slider-horizontal-text-below-left\">Nada útil</div>"+
			    "<div class=\"slider-horizontal-text-below-right\">Muy útil</div>"+
			    "<div id=\"slider-output-session-feedback\" style=\"text-align: center;\"><output id=\"sliderOutputSessionFeedback\">0</output></div>"+
			  "</form>"+
